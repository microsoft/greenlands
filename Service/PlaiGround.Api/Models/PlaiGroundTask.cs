...
/// </summary>
public class PlaiGroundTask : TaskInput
{
    /// <summary>
    ...
    public PlaiGroundTask()
    {
    }

    public PlaiGroundTask(string tournamentId, TaskInput taskInput)
    {
...
/// <summary>
/// Same as <see cref="PlaiGroundTask"/> but also includes the initial game
/// state, and target game changes.
/// </summary>
public class CompleteTask: PlaiGroundTask
{
    public GameState InitialGameState { get; set; }

    public IList<GameChanges> TargetGameChanges { get; set; }

    public CompleteTask(PlaiGroundTask task)
    {
