...
import com.microsoft.greenlands.client.model.AgentIsReadyEvent;
import com.microsoft.greenlands.client.model.AgentService;
...
public class AgentPairingSystem {
  ...
  public static void requestGameWithAgent(
    ...
    AsyncHelper.run(() -> {
      ...
      var tournament = GreenlandsServiceApi
          .tournamentsApi()
          .getTournamentById(tournamentId);

      var task = GreenlandsServiceApi
          .tasksApi()
          .getTaskById(tournamentId, taskId);

      var agentChallenge = GreenlandsServiceApi
          .agentChallengesApi()
