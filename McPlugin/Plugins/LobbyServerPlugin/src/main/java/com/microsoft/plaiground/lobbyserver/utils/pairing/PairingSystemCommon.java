...
import com.microsoft.plaiground.client.model.Game;
import com.microsoft.plaiground.client.model.PlaiGroundTask;
import com.microsoft.plaiground.client.model.Tournament;
...
class PairingSystemCommon {
  ...
  protected static void createGameForPlayersAndMoveThemToGameServer(
    ...
    var game = PlaigroundServiceApi.gamesApi().createGame(
        tournament.getId(),
        task.getId()
    );
