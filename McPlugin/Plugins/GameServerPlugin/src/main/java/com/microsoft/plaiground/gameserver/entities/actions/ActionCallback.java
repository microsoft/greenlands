  ...
  public void onActionEnd(Action action) {
    ...
    if (action.getState() == Action.ActionState.FAILURE) {
      ...
      if (action instanceof PlayerMoveAction) {
        ...
        playerMoveEvent.newLocation(LocationUtils.convertToPlaigroundLocation(agentLocation));
    ...
    if (action.getState() == Action.ActionState.SUCCESS) {
      if (action instanceof PlayerMoveAction) {
        ...
        playerMoveEvent.newLocation(LocationUtils.convertToPlaigroundLocation(targetLocation));
        EventHubProducerClient.sendGameEvent(
            playerMoveEvent,
            gameConfig,
            agentGameConfig
        ...
        blockRemoveEvent.location(LocationUtils.convertToPlaigroundLocation(targetLocation));
        EventHubProducerClient.sendGameEvent(
            blockRemoveEvent,
            gameConfig,
            agentGameConfig
        ...
        blockPlaceEvent.location(LocationUtils.convertToPlaigroundLocation(targetLocation));
