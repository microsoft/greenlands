...
import com.microsoft.plaiground.client.model.PlaiGroundTask;
...
import com.microsoft.plaiground.common.utils.MetadataUtils;
import com.microsoft.plaiground.common.utils.MinecraftLogger;
import com.microsoft.plaiground.common.utils.WorldUtils;
import com.microsoft.plaiground.gameserver.enums.GameBlockFunctions;
import com.microsoft.plaiground.gameserver.enums.GameMetadataKeys;
  ...
  public static void createGameWorldIfNecessary(GameConfig gameConfig,
    ...
    if (!WorldUtils.worldExists(worldName)) {
      var world = WorldUtils.createNormalWorld(
          ...
          plaigroundTask.getWorldSizeX(),
          plaigroundTask.getWorldSizeZ());
      ...
      if (targetState != null
        ...
        targetStructureInfoOption.ifPresent(targetStructureInfo -> {
          ...
          for (var locationBlockEntry : targetBlockChanges.entrySet()) {
            var location = LocationUtils.fromStringToPlaigroundLocation(
