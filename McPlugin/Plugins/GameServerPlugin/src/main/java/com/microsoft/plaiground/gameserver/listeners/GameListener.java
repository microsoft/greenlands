package com.microsoft.plaiground.gameserver.listeners;
...
import com.microsoft.plaiground.client.model.PlayerToggleFlightEvent;
...
import com.microsoft.plaiground.gameserver.utils.GameWorldUtils;
import com.microsoft.plaiground.gameserver.utils.PlayerRoleInGameUtils;
...
public class GameListener implements Listener {
  ...
  public void onPlayerJoinEvent(PlayerJoinEvent eventIn) {
    ...
    AsyncHelper.run(() -> {
      ...
      try {
        ...
        var taskInformation = PlaigroundServiceApi
            .tasksApi()
        ...
        var tournamentInfo = PlaigroundServiceApi
            .tournamentsApi()
  ...
  public void onBlockRemoveEvent(org.bukkit.event.block.BlockBreakEvent eventIn) {
    ...
    event.setLocation(
        LocationUtils.convertToPlaigroundLocation(eventIn.getBlock().getLocation()));
  ...
  public void onBlockPlaceEvent(org.bukkit.event.block.BlockPlaceEvent eventIn) {
    ...
    event.setRoleId(getRoleName(eventIn.getPlayer()));
    event.setLocation(
        LocationUtils.convertToPlaigroundLocation(eventIn.getBlockPlaced().getLocation()));
  ...
  public void onPlayerMoveEvent(org.bukkit.event.player.PlayerMoveEvent playerMoveEvent) {
    ...
    if (playerMovedMoreThanLimit) {
      ...
      event.setNewLocation(LocationUtils.convertToPlaigroundLocation(playerMoveEvent.getTo()));
